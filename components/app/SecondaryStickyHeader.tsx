            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <section
                  ...
                  onMouseLeave={scheduleCategoryClose}
                  className={`absolute left-1/2 -translate-x-1/2 top-full z-50 w-auto min-w-[550px] max-w-[90vw] cursor-default transition-all duration-200 ${openCategoryId === cat.id ? "visible translate-y-0 opacity-100" : "invisible -translate-y-2 opacity-0 pointer-events-none"}`}
                >
